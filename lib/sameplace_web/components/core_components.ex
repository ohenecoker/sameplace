defmodule SameplaceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SameplaceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SameplaceWeb.Gettext, "errors", msg, opts)
    end
  end
