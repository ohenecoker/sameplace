defmodule SameplaceWeb.RoomLive.FormComponent do
  use SameplaceWeb, :live_component
  ...
  def update(%{room: room} = assigns, socket) do
    changeset = Organizer.change_room(room)
  ...
  def handle_event("validate", %{"room" => room_params}, socket) do
    changeset =
      socket.assigns.room
      |> Organizer.change_room(room_params)
  ...
  defp save_room(socket, :edit, room_params) do
    case Organizer.update_room(socket.assigns.room, room_params) do
      {:ok, room} ->
